...
public class HRHCSummaryOutputOutputConfiguration implements Serializable {
    ...
    public HRHCSummaryOutputOutputConfiguration setFilrName(String FilrName) {
    ...
    public HRHCSummaryOutputOutputConfiguration setAutoSizeColumn(boolean AutoSizeColumn) {
    ...
    public HRHCSummaryOutputOutputConfiguration setColumnFormat(List<CustomDatastore.ColumnFormats> ColumnFormat) {
