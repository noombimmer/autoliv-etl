...
@Icon(value = CUSTOM, custom = "ECInput") // icon is located at src/main/resources/icons/ECInput.svg
@PartitionMapper(name = "ECInput")
@Documentation("TODO fill the documentation for this mapper")
public class ECInputMapper implements Serializable {
    private final ECInputMapperConfiguration configuration;
    private final AutolivEtlService service;
    private final RecordBuilderFactory recordBuilderFactory;

    public ECInputMapper(@Option("configuration") final ECInputMapperConfiguration configuration,
    ...
    @Split
    public List<ECInputMapper> split(@PartitionSize final long bundles) {
        ...
        // In this case bundles = 100 and we must try to return 10 ECInputMapper with 1/10 of the overall work each.
        //
    ...
    @Emitter
    public ECInputSource createWorker() {
        // here we create an actual worker,
        // you are free to rework the configuration etc but our default generated implementation
        // propagates the partition mapper entries.
        return new ECInputSource(configuration, service, recordBuilderFactory);
    }
}