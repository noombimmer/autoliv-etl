...
public class AutolivProcessorProcessorTest {
    ...
    public void map() throws IOException {
        ...
        final AutolivProcessorProcessorConfiguration configuration =  new AutolivProcessorProcessorConfiguration()
                                                                                /* .setColumnList()
                                                                                   .setSchemaList() */;

        // We create the component processor instance using the configuration filled above
        final Processor processor = COMPONENT_FACTORY.createProcessor(AutolivProcessorProcessor.class, configuration);
