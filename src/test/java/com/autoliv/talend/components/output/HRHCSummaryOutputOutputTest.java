...
public class HRHCSummaryOutputOutputTest {
    ...
    public void map() throws IOException {
        ...
        final HRHCSummaryOutputOutputConfiguration configuration =  new HRHCSummaryOutputOutputConfiguration()
                                                                                /* .setDataset()
                                                                                   .setFileName()
                                                                                   .setSheetName() */;

        // We create the component processor instance using the configuration filled above
        final Processor processor = COMPONENT_FACTORY.createProcessor(HRHCSummaryOutputOutput.class, configuration);
