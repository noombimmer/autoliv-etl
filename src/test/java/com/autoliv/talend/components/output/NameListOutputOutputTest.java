...
public class NameListOutputOutputTest {
    ...
    public void map() throws IOException {
        ...
        final NameListOutputOutputConfiguration configuration =  new NameListOutputOutputConfiguration()
                                                                                /* .setColumnFormat()
                                                                                   .setAutoSizeColumn()
                                                                                   .setDataset()
                                                                                   .setConfig()
        ...
        final Processor processor = COMPONENT_FACTORY.createProcessor(NameListOutputOutput.class, configuration);
