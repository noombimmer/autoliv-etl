...
public class UploadHRMOutputOutputTest {
    ...
    public void map() throws IOException {
        ...
        final UploadHRMOutputOutputConfiguration configuration =  new UploadHRMOutputOutputConfiguration()
                                                                                /* .setFilrName()
                                                                                   .setDataset()
                                                                                   .setSheetName() */;

        // We create the component processor instance using the configuration filled above
        final Processor processor = COMPONENT_FACTORY.createProcessor(UploadHRMOutputOutput.class, configuration);
